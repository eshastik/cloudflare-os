...
const PASSTHROUGH_GATEKEEPER_VARS = {
  "gatekeeper-mnemos": ["MNEMOS_TELEGRAM_DELIVERY_MODE", "MNEMOS_TELEGRAM_PUBLIC_ORIGIN", "MNEMOS_API_ORIGIN", "MNEMOS_STORAGE_ORIGIN", "MNEMOS_LOGIN_CONFIG", "MNEMOS_LOGIN_PROFILES", "MNEMOS_CALENDAR_BRIDGE_TOKEN", "MNEMOS_MAIL_BRIDGE_TOKEN", "MNEMOS_DRIVE_ORIGIN_KEY", "MNEMOS_CALDAV_SERVERS", "MNEMOS_IMAP_SERVERS", "MNEMOS_WEBDAV_SERVERS", "MNEMOS_WORKSPACE_ORIGIN", "MNEMOS_WORKSPACE_TOKEN"],
...
// ---------------------------------------------------------------------------
{
  ...
  const OPTIONAL_FEATURE_VARS = [
    ...
    "MNEMOS_STT_API_KEY", "MNEMOS_STT_URL", "MNEMOS_STT_MODEL", "MNEMOS_STT_PROTOCOL", "MNEMOS_CHAT_MODEL", "MNEMOS_CHAT_REASONING",
  ];
