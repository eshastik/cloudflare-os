...
export const REPOSITORY_FAILURES = {
  ...
  "git_repo.missing": "Репозиторий не найден в проекте или проект вам не виден. Обновите страницу.",
  "git_repo.not_revoked": "Доступ к репозиторию в GitHub не отозван: связь работает как обычно, выбирать «Оставить копию» не нужно.",
  "git_sync.github_access_unconfirmed": "GitHub не подтвердил вам доступ к этому репозиторию при последнем входе. Нажмите «Обновить доступ» у аккаунта GitHub и войдите заново.",
  "git_sync.github_not_connected": "Этот аккаунт GitHub подключили не вы. Нажмите «Подключить ещё аккаунт GitHub» и войдите в него.",
  "git_sync.github_missing": "Этот аккаунт GitHub уже отключён. Обновите страницу.",
  "git_sync.forbidden": "Это решает владелец проекта или администратор организации — у вас нет такого права.",
  "git_sync.duplicate": "Этот репозиторий уже есть в проекте: та же ветка и папка. Включите нужные возможности в его строке.",
  "git_sync.invalid": "Проверьте репозиторий, ветку, папку и шаблоны файлов.",
  "git_sync.missing": "Связь не найдена или проект вам не виден. Обновите страницу.",
  "git_sync.stale": "Связь изменилась. Обновите страницу и повторите.",
  "git_sync.repository": "Репозиторий недоступен выбранному входу в GitHub: проверьте, что доступ к нему открыт приложению Mnemos.",
  "git_sync.connect_unconfigured": "Приложение GitHub не настроено до конца: на сервере нет секрета клиента. Обратитесь к администратору сервера.",
  "git_sync.unavailable": "Приложение GitHub не настроено на сервере. Обратитесь к администратору сервера.",
  "git_sync.project_create_forbidden": "Создавать проекты вам не разрешает правило организации. Добавьте репозиторий в существующий проект.",
  "git_sync.signature": "Подпись доставки GitHub не сошлась.",
  "git.write_unconfirmed": "Не удалось подтвердить, что изменение записано. Обновите страницу и проверьте, прежде чем повторять.",
  "code_project.files_rejected": "Хранилище кода не приняло файлы: слишком много или слишком большие файлы либо недопустимые пути.",
  "project.personal_disabled": "Личные проекты в организации выключены: проект должен быть открыт отделу или организации.",
  "project.share_forbidden": "Поделиться проектом может тот, кто вправе его править; правила организации тоже могут это ограничивать.",
  "project.share_no_department": "Вы не состоите ни в одном отделе: открыть проект отделу нельзя. Попросите администратора добавить вас в отдел.",
  "project.sharing_settings_invalid": "Такой уровень видимости не поддерживается правилами организации.",
} as const;
