...
export const sections = {
  ...
  rules: { title: "Правила", description: "Как в компании создают проекты и делятся ими." },
  connections: { title: "Подключения", description: "Откуда агент берёт материалы и куда может писать — только с вашего согласия." },
