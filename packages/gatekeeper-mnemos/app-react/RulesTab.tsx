...
export default function RulesTab() {
  return <section aria-label="Правила организации">
    ...
    <Block title="Согласования">
      <Notice>Кто согласует изменения документов, задаётся в каждом проекте: страница проекта → «Участники» → «Правила согласования». Запросы на согласование приходят во «Входящие».</Notice>
    </Block>
  </section>;
}
