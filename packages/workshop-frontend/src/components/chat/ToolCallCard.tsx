    ...
    <div className="rounded-lg border border-kumo-line overflow-hidden">
      ...
      {open && (
        <div className="px-3 pb-3 pt-1 border-t border-kumo-line space-y-2">
          {tool.input && (
            <div>
              <span className="font-mono text-[10px] text-kumo-subtle uppercase tracking-wider">Вход</span>
          ...
          {tool.output && (
            <div>
              <span className="font-mono text-[10px] text-kumo-subtle uppercase tracking-wider">Выход</span>
