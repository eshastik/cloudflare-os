...
const SUGGESTIONS: TaskSuggestion[] = [
  ...
  {
    id: 'proposal',
    label: 'Подготовить предложение клиенту',
    description: 'Условия, сроки и стоимость по материалам проекта',
    icon: Handshake,
    prompt:
      'Подготовь коммерческое предложение клиенту по доступным материалам проекта: задача, состав работ, сроки и стоимость. Сначала уточни клиента, если он неизвестен. Не выдумывай недостающие условия и отметь, что нужно согласовать.',
  },
]
