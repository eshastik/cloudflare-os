      ...
      <Dialog className="p-6 sm:w-[480px]" size="base">
        ...
        <div className="space-y-4">
          <p className="text-sm text-kumo-subtle">
            Подключению Cloudflare доступно несколько аккаунтов. Выберите тот, с которого будет
            списываться оплата сверх бесплатного лимита.
          </p>
          ...
          {accounts === null ? (
            ...
            <Radio.Group
              ...
              disabled={saving}
            >
              <Radio.Legend className="sr-only">Аккаунт Cloudflare</Radio.Legend>
              {accounts.map((a) => (
